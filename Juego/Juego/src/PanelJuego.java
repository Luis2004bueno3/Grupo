...
public class PanelJuego extends JPanel implements ActionListener, KeyListener {
    ...
    public PanelJuego(VentanaJuego ventana, int dificultad) {
        ...
        jugador = new Coche(Color.BLUE, xAutopista + carril * 2, altoPantalla - 200, velocidadJugador, xAutopista, xAutopista + anchoAutopista);
    ...
    public void actionPerformed(ActionEvent e) {
        if (!pausado) {
            ...
            if (random.nextInt(24 - dificultad * 4) == 0) {
                ...
                enemigos.add(new Coche(Color.RED, xAutopista + posicionCarril * carril + offsetX, -120, 3 + dificultad, xAutopista, xAutopista + anchoAutopista));
            }
